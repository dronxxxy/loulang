...
static inline lou_sema_value_t *lou_sema_builtin_ret_fun_finalize(lou_sema_plugin_ctx ctx, lou_sema_value_t *value) {
  NOT_IMPLEMENTED;
}
...
static inline lou_sema_value_t *lou_sema_builtin_proc_fun_finalize(lou_sema_plugin_ctx ctx, lou_sema_value_t *value) {
  NOT_IMPLEMENTED;
}
