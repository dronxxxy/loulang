...
lou_hir_const_t *lou_hir_const_new_func(lou_mempool_t *mempool, lou_hir_type_t *type, lou_hir_func_t *func) {
  lou_hir_const_t *constant = LOU_MEMPOOL_ALLOC(mempool, lou_hir_const_t);
...
lou_hir_const_t *lou_hir_const_new_extern(lou_mempool_t *mempool, lou_hir_type_t *type, lou_slice_t name) {
  lou_hir_const_t *constant = LOU_MEMPOOL_ALLOC(mempool, lou_hir_const_t);
  constant->kind = LOU_HIR_CONST_EXTERNAL;
  constant->type = type;
  constant->external.name = name;
  return constant;
}
