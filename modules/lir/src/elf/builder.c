...
void lir_test() {
  unsigned char img[] = {
    0xb8, 0x01, 0x00, 0x00, 0x00,                               // mov eax, SYSCALL_WRITE
    0xbf, 0x01, 0x00, 0x00, 0x00,                               // mov edi, STDOUT
    0x48, 0xbe, 0x27, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, // mov rsi, hello_world
    0xba, 0x0f, 0x00, 0x00, 0x00,                               // mov edx, hello_world_len
    0x0f, 0x05,                                                 // syscall

    0xb8, 0x3c, 0x00, 0x00, 0x00, // move eax, SYSCALL_EXIT
    0xbf, 0x00, 0x00, 0x00, 0x00, // move edi, 0
    0x0f, 0x05,                   // syscall
